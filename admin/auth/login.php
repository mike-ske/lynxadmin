...
<body class="bg-gradient-primary">
    ...
    <div class="container" style="position: fixed;top: 50%;left: 50%;transform: translate(-50%, -50%);">
        ...
        <div class="row justify-content-center">
            ...
            <span class="col-lg-6 d-none d-lg-block text-center text-gray-300 small">Admin system managed and secured by <a href="http://www.lynxsite.herokuapp.com/0/" target="__blank" style="text-decoration: underline;">lynxlaboratories</a> Terms and conditions apply</span>
        </div>
