...
<body class="hold-transition sidebar-mini" style="background: #f4f6f9;">
  ...
  <div class="wrapper">
    ...
    <div class="text-center" style="position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);">
      <div class="error mx-auto" data-text="404" style="font-size: 10rem;color:#333;">404</div>
      <p class="lead text-gray-800 mb-5">Page Not Found</p>
      <p class="text-gray-500 mb-0">We could not find the page you were looking for.
        Meanwhile, you may </p>
